...
The transaction table ("transaction_tbl") should be an excel table, or a listobject, located on the "Transaction" sheet, with at least column headers (as datatypes/"values") _exactly_ of:
